...
class FarmUpdateRequest(object):
    ...
    def __init__(self, nonfree=None, tag_ids=None, tag_update_mode='replace', hardware_power_draw=None, psu_efficiency=None, octofan_correct_power=None, auto_tags=None, default_fs=None, _configuration=None):  # noqa: E501
        """FarmUpdateRequest - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def nonfree(self):
        """Gets the nonfree of this FarmUpdateRequest.  # noqa: E501

        Paid features state  # noqa: E501

        :return: The nonfree of this FarmUpdateRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def nonfree(self, nonfree):
        """Sets the nonfree of this FarmUpdateRequest.

        Paid features state  # noqa: E501

        :param nonfree: The nonfree of this FarmUpdateRequest.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def tag_ids(self):
        """Gets the tag_ids of this FarmUpdateRequest.  # noqa: E501


        :return: The tag_ids of this FarmUpdateRequest.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def tag_ids(self, tag_ids):
        """Sets the tag_ids of this FarmUpdateRequest.


        :param tag_ids: The tag_ids of this FarmUpdateRequest.  # noqa: E501
        :type: list[int]
        """
    ...
    def tag_update_mode(self):
        """Gets the tag_update_mode of this FarmUpdateRequest.  # noqa: E501
        ...
        :return: The tag_update_mode of this FarmUpdateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def tag_update_mode(self, tag_update_mode):
        """Sets the tag_update_mode of this FarmUpdateRequest.

        Update mode for tags * add - add spicified tags ignoring if already assigned; * remove - remove spicified tags if assigned; * replace - replace all assigned tags with specified ones;   # noqa: E501

        :param tag_update_mode: The tag_update_mode of this FarmUpdateRequest.  # noqa: E501
        :type: str
        """
    ...
    def hardware_power_draw(self):
        """Gets the hardware_power_draw of this FarmUpdateRequest.  # noqa: E501

        Power consumption of worker's hardware, watts  # noqa: E501

        :return: The hardware_power_draw of this FarmUpdateRequest.  # noqa: E501
        :rtype: int
        """
    ...
    def hardware_power_draw(self, hardware_power_draw):
        """Sets the hardware_power_draw of this FarmUpdateRequest.

        Power consumption of worker's hardware, watts  # noqa: E501

        :param hardware_power_draw: The hardware_power_draw of this FarmUpdateRequest.  # noqa: E501
        :type: int
        """
    ...
    def psu_efficiency(self):
        """Gets the psu_efficiency of this FarmUpdateRequest.  # noqa: E501

        Efficiency of power supply unit, %  # noqa: E501

        :return: The psu_efficiency of this FarmUpdateRequest.  # noqa: E501
        :rtype: int
        """
    ...
    def psu_efficiency(self, psu_efficiency):
        """Sets the psu_efficiency of this FarmUpdateRequest.

        Efficiency of power supply unit, %  # noqa: E501

        :param psu_efficiency: The psu_efficiency of this FarmUpdateRequest.  # noqa: E501
        :type: int
        """
    ...
    def octofan_correct_power(self):
        """Gets the octofan_correct_power of this FarmUpdateRequest.  # noqa: E501

        Apply power correction settings to power consumption value from Octominer fan controller. Default is false.  # noqa: E501

        :return: The octofan_correct_power of this FarmUpdateRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def octofan_correct_power(self, octofan_correct_power):
        """Sets the octofan_correct_power of this FarmUpdateRequest.

        Apply power correction settings to power consumption value from Octominer fan controller. Default is false.  # noqa: E501

        :param octofan_correct_power: The octofan_correct_power of this FarmUpdateRequest.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def auto_tags(self):
        """Gets the auto_tags of this FarmUpdateRequest.  # noqa: E501
        ...
        :return: The auto_tags of this FarmUpdateRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def auto_tags(self, auto_tags):
        """Sets the auto_tags of this FarmUpdateRequest.

        Auto-tags feature. If enabled - all workers inside the farm are automatically tagged. Rigs are tagged by GPU information such as model name, memory size, OEM, etc. ASICs are tagged by model name.   # noqa: E501

        :param auto_tags: The auto_tags of this FarmUpdateRequest.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def default_fs(self):
        """Gets the default_fs of this FarmUpdateRequest.  # noqa: E501
        ...
        :return: The default_fs of this FarmUpdateRequest.  # noqa: E501
        :rtype: dict(str, int)
        """
    ...
    def default_fs(self, default_fs):
        """Sets the default_fs of this FarmUpdateRequest.

        Default flight sheets keyed by platform (1 - rig, 2 - asic). These flight sheets will be automatically attached to newly created workers.   # noqa: E501

        :param default_fs: The default_fs of this FarmUpdateRequest.  # noqa: E501
        :type: dict(str, int)
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FarmUpdateRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FarmUpdateRequest):
            return False
